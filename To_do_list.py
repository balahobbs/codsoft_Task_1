...
def addwork():
    ...
    if task != "":
        ...
        messagebox.showwarning("warning", "Enter the tasks you want.")
...
task_list = ['Learn books',
    'Meditate',
    'Do Coding',
    'Go for jagging',
    'Note the imrovements',]
...
addTask_btn = Button(button_frame,text='Add Task',font=('times 14'),bg='#00ff00',padx=20,pady=10,command=addwork)
